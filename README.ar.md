...
<p align="center">
  <a href="https://farooq-bizmanager-demo.vercel.app"><b>🟢 نسخة تجريبية حيّة — جرّبها الآن</b></a> · بلا تسجيل، بيانات وهمية، تُجدَّد كل ليلة
</p>
...
👉 **[دليل التثبيت — خطوة بخطوة، مع الصور](docs/INSTALL.ar.md)**

👉 **[التشغيل على خادمك الخاص](docs/SELF-HOSTING.ar.md)** — الخادم، النطاق، النسخ الاحتياطي، التحديث والأمان
